...
class ConfClasses(Model):
    ...
    def __init__(self, conforms_to: List[str]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ConfClasses':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The confClasses of this ConfClasses.
        """
    ...
    def conforms_to(self, conforms_to):
        ...
        if conforms_to is None:
            raise ValueError("Invalid value for `conforms_to`, must not be `None`")
