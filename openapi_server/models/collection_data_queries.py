...
class CollectionDataQueries(Model):
    ...
    def __init__(self, position: CollectionDataQueriesPosition=None, radius: CollectionDataQueriesPosition=None, area: CollectionDataQueriesPosition=None, cube: CollectionDataQueriesPosition=None, trajectory: CollectionDataQueriesPosition=None, corridor: CollectionDataQueriesPosition=None, locations: CollectionDataQueriesPosition=None, items: CollectionDataQueriesPosition=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CollectionDataQueries':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The collection_data_queries of this CollectionDataQueries.
        """
