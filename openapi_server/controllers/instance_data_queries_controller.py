...
async def get_instance_data_for_area(request: web.Request, collection_id, instance_id, coords, z=None, datetime=None, parameter_name=None, resolution_x=None, resolution_y=None, crs=None, f=None) -> web.Response:
...
async def get_instance_data_for_corridor(request: web.Request, collection_id, instance_id, coords, corridor_width, width_units, corridor_height, height_units, z=None, datetime=None, parameter_name=None, resolution_x=None, resolution_z=None, crs=None, f=None) -> web.Response:
...
async def get_instance_data_for_cube(request: web.Request, collection_id, instance_id, bbox=None, z=None, datetime=None, parameter_name=None, crs=None, f=None) -> web.Response:
...
async def get_instance_data_for_location(request: web.Request, collection_id, instance_id, location_id, datetime=None, crs=None, f=None) -> web.Response:
...
async def get_instance_data_for_point(request: web.Request, collection_id, instance_id, coords, z=None, datetime=None, parameter_name=None, crs=None, f=None) -> web.Response:
...
async def get_instance_data_for_radius(request: web.Request, collection_id, instance_id, coords, within, within_units, z=None, datetime=None, parameter_name=None, crs=None, f=None) -> web.Response:
...
async def get_instance_data_for_trajectory(request: web.Request, collection_id, instance_id, coords, z=None, datetime=None, parameter_name=None, crs=None, f=None) -> web.Response:
