...
class OgcApiCollectionDataByRadius(OgcApi):
    def get_data_for_radius(
        ...
        * Open intervals: \&quot;2018-02-12T00:00:00Z/..\&quot; or
        ...
        """
        api_path = "/collections/{collectionId}/radius"
        ...
        if best_match == "text/html":
            ...
            the_ret_data = self._get_collection_data_by_radius(
                thecollection_value, collection_id, coords, within, within_units,
                z, datetime, parameter_name, crs, best_match)
        print("best_match=", best_match)
        the_final_ret = self._format_get_data_for_radius(
    ...
    def _format_get_data_for_radius(
        ...
        if theplugin is None:
            Logger.warning("No formaater for mediatype={} for {}.".format(
                mediatype, "collection_edr_radius"
            ))
            return thedata
    ...
    def _get_collection_data_by_radius(
            self, collection_spec, collection_id, coords, within,
            within_units, z=None, datetime=None, parameter_name=None, crs=None,
            f=None):
        try:
            ...
            thedata = theprovider.get_data_for_radius(
                collection_id, coords, within, within_units, z,
